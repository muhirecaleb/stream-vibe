    ...
    <div className="space-y-12 pb-20">
      ...
      <div className="relative h-[60vh] w-full overflow-hidden rounded-xl">
         ...
         <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12">
            <h1 className="text-4xl font-bold tracking-tight md:text-6xl mb-4">{movie.title}</h1>
      ...
      <div className="grid gap-12 md:grid-cols-[2fr_1fr]">
         ...
         {/* Sidebar like info or similar movies could go here if vertically stacked */}
         {/* For now we just put recommendations below */}
      </div>

      {/* Recommendations */}
      {recommendations.results && recommendations.results.length > 0 && (
          <MovieGrid title="You May Also Like" movies={recommendations.results.slice(0,10)} />
      )}
    </div>
  );
}
